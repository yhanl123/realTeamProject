...
<form id="joinForm" action="/member/add" method="post" onsubmit="return join();">
	<div id="name">
		<input type="text" id="memberName" name="memberName" placeholder="이름" onfocus="this.placeholder=''" onblur="this.placeholder='이름'">
	</div>
	<div id="ID">
	...
	<div id="email">
		<input type="text" id="memberEmail" name="memberEmail" placeholder="이메일 (비밀번호 분실 시 확인용 이메일)" onfocus="this.placeholder=''" onblur="this.placeholder='비밀번호 분실 시 확인용 이메일'">
	</div>
	<div id="address">
		<input id="post" name="post" type="text" placeholder="우편번호" readonly onclick="findAddr()">
		<input id="member_addr" name="address" type="text" placeholder="주소" readonly> <br>
		<input type="text" id="detailAddress" name="detailAddress" placeholder="상세주소">
		<!--  <input type="text" id="memberAddress" name="memberAddress" placeholder="주소" onfocus="this.placeholder=''" onblur="this.placeholder='주소'"> -->
	</div>

	<div id="birth">
		<input type="DATE" id="memberBirth" name="memberBirth" placeholder="생년월일" onfocus="this.placeholder=''" onblur="this.placeholder='생년월일'">
	</div>
	<div id="phone">
		<input type="text" id="memberPhone" name="memberPhone" maxlength="11" placeholder="휴대전화번호 (숫자만 입력 해 주세요.)" onfocus="this.placeholder=''" onblur="this.placeholder='휴대전화번호 (숫자만 입력 해 주세요.)'">
	</div>
	<div id="sexAndNational">
		<fieldset>
				<input type="hidden" id="memberSex" name="memberSex">
					남자 <input type="radio" name="memberSex" id="memberSex" value="m" checked>
					여자 <input type="radio" name="memberSex" id="memberSex" value="f">
		</fieldset>
		<fieldset>
	...
	<div id="interest">
		<fieldset>
				<input type="hidden" id="interest" name="interest">
					...
					<input type="checkbox" name="interest" value="6"> 6
					<input type="checkbox" name="interest" value="7"> 7
					<input type="checkbox" name="interest" value="8"> 8
					<input type="checkbox" name="interest" value="9"> 9
					<input type="checkbox" name="interest" value="10"> 10
		</fieldset>
	</div>
	[필수] 이용약관 동의 <br>
	<textarea rows="6" cols="80" style="white-space:pre;">
	제1조(목적)
	이 약관은 쇼핑몰 회사(전자상거래 사업자)가 운영하는 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
	...
	#카카오톡 알림톡 시행에 관한 내용
	“OOO쇼핑몰”은 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
	</textarea>
	<br>이용약관에 동의하십니까? <input type="checkbox"> 동의함 <br>
	[필수] 개인정보 수집 및 이용 동의
	<textarea rows="6" cols="80" style="white-space:pre;">
	1. 개인정보 수집목적 및 이용목적
